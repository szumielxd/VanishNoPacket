...
import org.kitteh.vanish.Commands.VanishCommand;
import org.kitteh.vanish.Commands.VanishTab;
...
public final class VanishPlugin extends JavaPlugin {
	...
	public void onEnable() {
		...
		if (!check.exists()) {
			...
			if (this.getServer().getPluginManager().isPluginEnabled("PlaceholderAPI")) {
				this.getConfig().set("hooks.placeholderapi", true);
				this.getLogger().info("Detected PlaceholderAPI. Enabling PlaceholderAPI hook.");
				this.saveConfig();
			}
		}
		...
		if (this.getConfig().getBoolean("hooks.placeholderapi", false)) {
			this.hookManager.getHook(HookType.PlaceholderAPI).onEnable();
		}
		...
		//ActionBar enabled
		if(Settings.isUsingActionBar()) this.getManager().startActionBarUpdateTimer();

		this.getCommand("vanish").setExecutor(new VanishCommand(this));
		this.getCommand("vanish").setTabCompleter(new VanishTab());
	 ...
	 */
	public void reload() {
		this.getManager().stopActionBarUpdateTimer();
		this.reloadConfig();
		Settings.freshStart(this);
		this.getHookManager().onDisable();
		this.getHookManager().onEnable();
		if(Settings.isUsingActionBar()) this.getManager().startActionBarUpdateTimer();
	}
